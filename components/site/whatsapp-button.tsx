...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className={`fixed bottom-6 end-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-green-600/30 transition-all duration-500 hover:scale-110 ${
